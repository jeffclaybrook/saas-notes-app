  ...
  <div className="grid items-start gap-y-8">
   <div className="flex items-center justify-between px-2">
    <div className="grid gap-1">
     ...
     <p className="text-lg text-muted-foreground">View and create notes here</p>
    </div>
   ...
   {data?.Notes.length === 0 ? (
    <div className="flex min-h-[400px] flex-col items-center justify-center rounded-md border border-dashed p-8 text-center animate-in fade-in-50">
     ...
     <p className="mb-8 mt-2 text-center text-sm leading-6 text-muted-foreground max-w-sm mx-auto">You haven&#39;t created any notes. Create your first note to get started.</p>
     {data?.Subscription?.status === "active" ? (
      <Button asChild>
       <Link href="/dashboard/new">Create New Note</Link>
      </Button>
